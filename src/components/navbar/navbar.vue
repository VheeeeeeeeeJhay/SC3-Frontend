...
<div class="flex items-center space-x-6">
  <!-- 911-SCC Button -->
  <button class="relative text-2xl font-bold uppercase tracking-wide text-transparent border-none bg-transparent cursor-pointer overflow-hidden">
    ...
    <span class="relative z-10 block text-stroke text-white/60 hover:text-green-500 transition-all duration-500">
      <router-link to="/" class="block px-4 py-2 text-green-500">911-SCC</router-link>
    </span>
  </button>
  ...
  <button class="relative text-2xl font-bold uppercase tracking-wide text-transparent border-none bg-transparent cursor-pointer overflow-hidden">
    <span class="absolute inset-0 w-0 border-r-2 border-green-500 transition-all duration-500 hover:w-full"></span>
    <span class="relative z-10 block text-stroke text-white/60 hover:text-green-500 transition-all duration-500">
      <a href="https://www.gov.ph" target="_blank" rel="noopener noreferrer" class="block px-4 py-2 text-green-500">GOVPH</a>
    </span>
  </button>
</div>
