            ...
            <div class="p-6 rounded-lg shadow-lg flex bg-sky-50 text-gray-800 dark:bg-slate-800 dark:text-white">
                ...
                <div class="w-1/2 pl-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-group">
                            <div role='status' class='max-w max-[35vh] border border-gray-300 rounded-lg p-4'>
                                <div
                                    class="animate-pulse w-full bg-gray-300 h-48 rounded-lg flex justify-center items-center">
                                    <svg class="w-8 h-8 stroke-gray-400" viewBox="0 0 24 24" fill="none"
