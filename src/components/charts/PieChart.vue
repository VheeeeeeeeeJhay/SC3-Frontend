...
<template>
    <div class=" w-full flex items-center justify-center">
        ...
        <!-- Button dito -->
        <!-- <Dropdown v-model="selectedOption" :options="options" placeholder="Select a Crime Type" class="w-full mb-3" />
        <div v-if="selectedOption">You have selected: {{ selectedOption }}</div> -->
        <div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6 mx-4">

<div class="flex justify-between items-start w-full">
    <div class="flex-col items-center">
      <div class="flex items-center mb-1">
          <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Crime Statistics</h5>
