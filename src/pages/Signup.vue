    ...
    <div class="bg-white p-6 rounded-xl shadow-lg max-w-lg">
      ...
      <form @submit.prevent="submit" class="flex grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input type="text" v-model="data.middleName" id="middleName" name="middleName" class="mt-1 w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
          <label for="lastName" class="block text-sm font-medium text-gray-700">Last Name</label>
          <input type="text" v-model="data.lastName" id="lastName" name="lastName" class="mt-1 w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
