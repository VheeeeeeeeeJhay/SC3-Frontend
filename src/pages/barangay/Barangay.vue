            ...
            <table v-else class="w-full text-sm text-left border border-gray-600 divide-y divide-gray-600"
              ...
              <tbody>
                <tr v-for="barangay in paginatedBarangays" :key="barangay.id"
                  ...
                  <td class="px-4 py-3 border border-gray-600" v-if="barangay.longitude">{{ barangay.longitude }}</td>
                  <td class="px-4 py-3 border border-gray-600" v-if="!barangay.longitude"><Badge Message="No Data for Longitude" /></td>
                  <td class="px-4 py-3 border border-gray-600" v-if="barangay.latitude">{{ barangay.latitude }}</td>
                  <td class="px-4 py-3 border border-gray-600" v-if="!barangay.latitude"><Badge Message="No Data for Latitude" /></td>
          ...
          <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4">
            ...
            <ul class="inline-flex items-stretch -space-x-px">
              ...
              <li v-for="page in totalPages" :key="page">
                <button @click="currentPage = page" :class="[hoverClasses, { [hoverClasses]: page === currentPage }]"
