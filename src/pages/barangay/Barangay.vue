...
const formSubmit = async (barangay_Id) => {
  try {
    errors.value = ''; // 🔹 Reset errors before making a request
    await axiosClient.delete(`/api/911/barangay-delete/${barangay_Id}`, {
        headers: {
            'x-api-key': API_KEY
        }
    })
    ...
    errors.value = 'Failed to delete barangay. Please try again.';
  }
};
...
<template>
    ...
    <div v-if="isLoading" class="flex justify-center mt-96">
      <!-- <div role="status">
                                  ...
                                  <td class="px-4 py-3">
                                    <div class="p-2 space-x-2">
                                      ...
                                      <Modal v-if="isEditModalOpen" v-model="isEditModalOpen" @click.stop >
                                        <template #contents>
                                          <div class="p-6">
                                            <EditBarangay v-if="selectedBarangay" :barangay_data="selectedBarangay" @updateValue="handleUpdate"/>
                                          </div>
                                          <!-- <FormInput /> -->
                                        </template>
                                      </Modal>
